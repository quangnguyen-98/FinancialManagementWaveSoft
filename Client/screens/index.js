import DangNhapScreen from "./dungChung/DangNhapScreen";
import DoiMatKhauScreen from "./dungChung/DoiMatKhauScreen";
import ThongTinUserScreen from "./dungChung/ThongTinUserScreen";
import ChiTietChuChoVayScreen from "./admin/ChiTietChuChoVayScreen";
import QuanLyChuChoVayScreen from "./admin/QuanLyChuChoVayScreen";
import ThemChuChoVayScreen from "./admin/ThemChuChoVayScreen";
import ThongBaoHeThongScreen from "./admin/ThongBaoHeThongScreen";
...
export {
    ...
    DoiMatKhauScreen,
    ThongTinUserScreen,
    ChiTietChuChoVayScreen,
    QuanLyChuChoVayScreen,
    ThemChuChoVayScreen,
    ThongBaoHeThongScreen,
